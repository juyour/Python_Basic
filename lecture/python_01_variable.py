...
# name 변수 생성
# "Juyour Park" 값을 name 변수에 담기

# name(변수명), =(대입 연산자), "Juyour Park"(값)
name = "Juyour Park"
...
# 4. 예약어 사용 불가
#    예약어: Python애서 미리 선정하여 사용중인 키워드
#           ex) print, for, while, if, else , class, try, except, True, False,
#           and, return, import, def, pass, break, continue, del, etc..
# Naming Method
...
# 웹 디자이너 서버 엔지니어(Linux 운영 관리) + 클라우드 개발자
# 네트워크 엔지너어
...
# 동적 출력!
print("=" * 200)
student_num = 20233104
student_name = "Juyour Park"

# 출력 예: "조선대학교 20233104 Juyour Park입니다."
print("조선대학교 20233104 Juyour Park입니다.")  # 하드 코딩 지양!
